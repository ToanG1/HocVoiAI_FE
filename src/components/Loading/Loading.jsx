...
export default function Loading() {
  ...
  const potsTimeline = [...document.querySelectorAll(".pot")].map((pot, i) => {
    return gsap.from(pot, POTS_TIMES[i].duration, {
      delay: POTS_TIMES[i].delay,
      y: -POT_BOTTOM_Y,
    });
  });

  const shadowsTimeline = [...document.querySelectorAll(".pot-shadow")].map(
    (shadow, i) => {
      return gsap.from(shadow, POTS_TIMES[i].duration, {
        ease: "power3.inOut",
        delay: POTS_TIMES[i].delay,
        scale: 0,
  ...
  const leafsTimeline = [...document.querySelectorAll(".leaf")].map((leaf) => {
    ...
    return gsap.from(leaf, 0.5 + Math.random() * 0.8, {
      delay: isBack ? 0.5 : 0,
      ease: `elastic(0.5, ${Math.random()})`,
      scale: 0,
  ...
  const flowersTimeline = [...document.querySelectorAll(".flower")].map(
    (flower) => {
      const isLeft = flower.classList.contains("flower-left");

      return gsap.from(flower, 1 + Math.random() * 1, {
        ease: "circ",
        scale: 0,
        ...
        >
          <defs>
            <clipPath id="haworthia-clip-path">
              <path
                className="no-fill"
                d="M346.55,207H19.41V406.62h83.88c1.11,4.16,36.24,7.5,79.45,7.5s78.33-3.34,79.44-7.5h84.37Z"
              />
            </clipPath>
            <clipPath id="cactus-clip-path">
              <path
                className="no-fill"
                d="M297.57,215.13V406.42h58c0,4.25,35.59,7.7,79.49,7.7s79.5-3.45,79.5-7.7h53.67V215.13Z"
              />
            </clipPath>
            <clipPath id="echeveria-clip-path">
              <path
                className="no-fill"
                d="M553.15,240.87V406.42h58.56c0,4.25,35.6,7.7,79.5,7.7s79.5-3.45,79.5-7.7h62.5V240.87Z"
              />
            </clipPath>
          </defs>

          <rect className="back" width="850.5" height="850.5" />

          <text x="436" y="700" text-anchor="middle" className="replay-text">
            Click anywhere to replay
          </text>

          <ellipse
            className="pot-shadow"
            cx="181.74"
            cy="577.62"
            rx="79.66"
            ry="19.62"
          ...
          <g className="pot">
            <path
              className="pot-lightest"
              d="M183.74,406.62H91.66c-17,54,1,118,39.15,172H236.66c38.1-54,56.11-118,39.15-172Z"
            />
            <path
              className="pot-lighter"
              d="M275.81,406.62h-.63a2.44,2.44,0,0,1,.69,1.6c0,5.25-21.77,9.78-53.2,11.87-3.29,17.67-17.12,34.26-35.13,47C164.64,483,135.2,493,103,493q-6.24,0-12.43-.47c7.14,29.54,21.18,59.08,40.26,86.14H236.66C274.76,524.59,292.77,460.65,275.81,406.62Z"
            />
          ...
          <g className="haworthia plant">
            <g className="leaf">
              ...
              <path
                className="haworthia-strip"
                d="M193.77,311.41q-.81-4-1.6-7.83l-.36.37-2.84.49-2.85-2.34-2.84.27-2.84-1.11-2.85,5.58-2.84-2.1-2.84,1.14-2-1.38q-.81,3.92-1.62,8l.88,1.39,2.85-.09,2.84-.15,2.84-.26,2.84-3.27,2.84,4.88,2.85-3.09,2.84-.06,2.84,1.61Z"
              />
              <path
                className="haworthia-strip"
                d="M199.08,340.39l-1.59.87-2.84.42-2.84-4.62-2.84.47-2.85,3.55-2.84-2-2.84-1.3-2.85,5.07-2.84-4.47-2.84.08-2.85.15-2.84.27-2.84,3.27-.4-.69c-.55,3.34-1.08,6.71-1.59,10.09l2.05-3.4,2.84,3.68,2.84,1.14,2.85-1.33,2.84,1.15,2.84-2,2.84-1.17,2.84-1.61,2.85,4.47,2.84-3.7,2.84-.81,2.85-.14,2.84.17,2.85,3.94.52.17Q200,346.18,199.08,340.39Z"
              />
              <path
                className="haworthia-strip"
                d="M203.83,416.18,201,416l-2.85.29-2.84,1.43-2.85-1.59-2.84,1-2.84.61-2.84-.41-2.84-.48-2.85,4.73L175.4,418l-2.84-1.14-2.85,1.33L166.87,417l-2.84,2-2.85,1.16-2.84,1.61L156,418.2a168.84,168.84,0,0,0,1.74,21.07l.63.18h2.84l2.85-1.53,2.84,2.22,2.84-5.06,2.84,3.18,2.84-1.54,2.85,1.55,2.84-3.9,2.84,4,2.85-1.13,2.84-2.79,2.85,6,2.84-1.07,2.84-.71,2.85-3.68,2.84,4.94.62-1a169.91,169.91,0,0,0,1.69-21.07Z"
              />
              <path
                className="haworthia-strip"
              ...
              />
              <path
                className="haworthia-ouline"
                d="M181.11,256S156,350.42,156,412.9s25.14,69.34,25.14,69.34,25.15-6.85,25.15-69.34S181.11,256,181.11,256Zm0,206.09s-17.29-5.63-17.29-57,17.29-128.93,17.29-128.93,17.3,77.6,17.3,128.93S181.11,462,181.11,462Z"
              />
            </g>
            <g className="leaf">
            ...
            <g className="leaf">
              ...
              <path
                className="haworthia-strip"
                d="M243,361.25c.49-2.33,1-4.6,1.5-6.83l-.44.16-2.55-.73q-.75-1.5-1.47-3l-2.46-.91-1.92-2c-1.53,1.14-3.05,2.28-4.58,3.45-.52-1-1-1.9-1.54-2.85l-2.83-.16c-.39-.65-.77-1.3-1.14-2q-2.29,3-4.62,6.14l.21,1.5,2.45,1L226,356l2.52.85,3.65-1.63c.18,1.7.38,3.39.59,5.08,1.19-.49,2.37-1,3.55-1.45l2.43,1,1.84,2.37Z"
              />
              <path
                className="haworthia-strip"
                d="M238.48,386.3l-1.66.21-2.68-.55c-.42-1.56-.82-3.12-1.21-4.69l-2.68-.53-3.61,2c-.65-.86-1.3-1.73-1.94-2.6l-2.14-2q-2.07,1.68-4.13,3.41c-.4-1.57-.78-3.15-1.15-4.73l-2.57-.84-2.59-.78-2.64-.68-3.65,2c0-.25-.09-.49-.13-.74q-2.41,4.19-4.72,8.54c1-.82,2-1.64,3-2.44.47,1.37,1,2.75,1.45,4.11.75.62,1.51,1.23,2.27,1.83l3-.34,2.27,1.82,3.19-.93,2.93-.16,3.06-.52c.43,1.54.89,3.08,1.35,4.61,1.21-.77,2.41-1.53,3.62-2.28l2.81.19,2.63.73,2.54,1c.52,1.36,1.05,2.7,1.59,4l.44.29Q237.75,391.28,238.48,386.3Z"
              />
              <path
                className="haworthia-strip"
                d="M228.82,449.71l-2.85-.5-2.91-.13-3,.85-2.71-1.74-3,.54-2.94.16-2.83-.72-2.81-.8q-1.72,1.92-3.44,3.89-1.25-1.83-2.44-3.69l-2.73-1.4-3,.85-2.72-1.43-3.15,1.53-3.05.75-3.1,1.19c-.62-1.24-1.22-2.49-1.82-3.75a105.12,105.12,0,0,0-.78,20.44l.64.22,2.94.19,3.08-1.25c.91.78,1.83,1.54,2.75,2.3q1.68-2.28,3.38-4.51c.88,1.06,1.77,2.12,2.66,3.16l3.06-1.19,2.82,1.63q1.6-1.67,3.23-3.3c.87,1.27,1.75,2.54,2.64,3.79l3-.79,3.12-2.22c.84,1.84,1.69,3.68,2.57,5.49l3-.73,3-.4q1.56-1.47,3.14-2.91,1.32,2.2,2.69,4.38l.69-.82c1.21-5.07,2.25-10.82,3.15-17.38Z"
              />
              <path
                className="haworthia-strip"
                d="M234.58,418.42l-.31-.49c-1.26,1.32-2.51,2.65-3.76,4q-1-2.25-1.88-4.51-1.57.6-3.15,1.23c-.71-1.12-1.41-2.24-2.1-3.37q-1.9,2-3.81,4-.78-2.93-1.48-5.89-2,2.28-4,4.61-.94-2.14-1.86-4.3l-2.55-1.35-2.72-.64-3.08.71c-.74-.87-1.48-1.75-2.21-2.64q-2,1.95-3.91,3.95c-.67-1.17-1.33-2.35-2-3.53-1,.25-2.07.51-3.1.78l-2.35-2.08-.71.57c-1.7,4.51-3.23,9-4.54,13.52.39,1.05.78,2.08,1.17,3.12,1.36-1.83,2.73-3.63,4.11-5.42q1.08,1.62,2.19,3.21l2.88.13,2.68,1,3.33-2,2.42,2.19c.74,1.09,1.48,2.17,2.24,3.25l2.75.76q1.83-2,3.68-3.91l2.8.45,2.44,2.26c.75,1.1,1.51,2.19,2.27,3.27l3.13-1.24,3-.38L229,430c.81.83,1.62,1.66,2.44,2.48l1.76.36C233.63,428.12,234.09,423.31,234.58,418.42Z"
              />
              <path
                className="haworthia-ouline"
          ...
          <g className="pot">
            <path
              className="pot-lightest"
              d="M436.07,406.62H344c-17,54,1.05,118,39.15,172H489c38.1-54,56.11-118,39.15-172Z"
            />
            <path
              className="pot-lighter"
              d="M528.15,406.62h-.63a2.49,2.49,0,0,1,.69,1.6c0,5.25-21.77,9.78-53.21,11.87-3.28,17.67-17.11,34.26-35.13,47C417,483,387.54,493,355.32,493q-6.24,0-12.43-.47c7.14,29.54,21.18,59.08,40.26,86.14H489C527.1,524.59,545.11,460.65,528.15,406.62Z"
            />
          ...
          <g className="cactus plant">
            <g className="leaf">
              <line
                className="cactus-prickle"
                x1="519.14"
                y1="354.57"
                x2="528.68"
                y2="343.31"
              ...
              <path
                className="cactus-lighter"
                d="M503.33,375.59c8.73-12.23,15.1-24.7,18.73-35.78a48.76,48.76,0,0,0-9.49-8.41c-14.36-10.24-28.65-14.82-49.84,14.87-10.32,14.46-20.37,34.4-26.3,52.22,0,7,1.93,12.33,6,15.23C454.77,422.52,482,405.45,503.33,375.59Z"
              />
              <ellipse
                className="cactus-lightest"
                cx="485.71"
                cy="351.52"
                rx="22.94"
                ry="14.99"
                transform="translate(-82.54 542.76) rotate(-54.49)"
              />
              <line
                className="cactus-prickle"
                x1="439.6"
            ...
            <g className="flower flower-left">
              <path
                className="flower-back"
                d="M349.52,301.89c-.19-4.68,1.18-8.81,4.89-11.19-.86-3.38.1-6.85,2.17-10.08,1.95-3,4.51-5.29,7.67-6.06,1-3.74,4-6.33,7.9-7.93,6.71-2.74,13.63-1.59,17.69,7.67,3.75,8.56,3.74,21-1.59,25.05a5.68,5.68,0,0,1-.6,1.21,6.27,6.27,0,0,1-1.56,1.65c-.75,6.82-12.55,12.39-22.21,12.56C353.77,314.94,349.83,309.13,349.52,301.89Z"
              />
              <path
                className="flower-root"
                d="M370,305.1c8.58,5.5,22.59,7.38,26.58,1.17S393,288.1,384.45,282.59s-14.95-2.48-18.94,3.74S361.42,299.59,370,305.1Z"
              />
              <path
                className="flower-lighter"
                d="M367.48,285.4c4,9.39,14.48,18.85,21.28,16s7.32-17,3.35-26.39-10.94-10.49-17.74-7.61S363.51,276,367.48,285.4Z"
              />
              <path
                className="flower-lighter"
                d="M364.65,289.82c10.19-.3,23.17,5.31,23.39,12.69s-12.41,13.74-22.61,14-14.09-5.57-14.3-12.95S354.45,290.12,364.65,289.82Z"
              />
              <path d="M361.62,302.74c8.58,5.51,23.21,6.43,28-1s-2.19-20.31-10.77-25.82-15.56-1.52-20.31,5.88S353,297.23,361.62,302.74Z" />
              <path
                className="flower-lighter"
                d="M363,300.6c8.58,5.5,22.59,7.38,26.58,1.17S386,283.6,377.43,278.09s-14.94-2.48-18.93,3.74S354.41,295.09,363,300.6Z"
              />
            </g>
            <g className="leaf">
              <line
              ...
              <path
                className="cactus-lighter"
                d="M449.6,317.31c0-20-2.74-38.4-7.36-53.19a65.26,65.26,0,0,0-16.77-1.77c-23.45,0-42.47,6.08-42.47,54.57,0,23.63,4.52,53,11.86,76.84,5.37,7.54,11.61,11.86,18.26,11.86C433.27,405.62,449.6,366.08,449.6,317.31Z"
              />
              <ellipse
                className="cactus-lightest"
                cx="411.93"
            ...
            <g className="leaf">
              ...
              <path
                className="cactus-lighter"
                d="M381.11,355.44a117.16,117.16,0,0,0-29-16.43,40.14,40.14,0,0,0-7.55,7c-9.37,10.7-14,21.64,9.78,39.68a180.16,180.16,0,0,0,42.37,23.16c5.84.35,10.44-.89,13.1-3.93C417.85,395.73,405,373.57,381.11,355.44Z"
              />
              <ellipse
                className="cactus-lightest"
                cx="359.98"
                ...
                rx="12.04"
                ry="18.79"
                transform="matrix(0.57, -0.82, 0.82, 0.57, -147.09, 456.85)"
              />
              <line
                className="cactus-prickle"
                x1="419.34"
            ...
            <g className="flower">
              ...
              <path
                className="flower-root"
                d="M475.45,292.74c-9.69,8.2-26.68,12.82-32.62,5.8s1.42-23,11.11-31.21,18-5.51,24,1.5S485.14,284.53,475.45,292.74Z"
              />
              <path
                className="flower-lighter"
                d="M475.33,268c-3.36,12.24-14.78,25.65-23.64,23.21s-11.83-19.79-8.46-32,11.78-14.74,20.65-12.3S478.7,255.77,475.33,268Z"
              />
              <path
                className="flower-lighter"
                d="M479.56,273c-12.63,1.31-27.73,10.36-26.79,19.5s17.58,14.93,30.21,13.62,16.47-9.19,15.53-18.33S492.19,271.7,479.56,273Z"
              />
              <path d="M485.42,288.45c-9.69,8.21-27.6,11.74-34.67,3.39s-.64-25.43,9.05-33.64,19-4.42,26,3.93S495.11,280.25,485.42,288.45Z" />
              <path
                className="flower-lighter"
                d="M483.37,286c-9.69,8.21-26.68,12.83-32.62,5.81s1.41-23,11.1-31.22,18-5.51,24,1.51S493.06,277.83,483.37,286Z"
              />
            </g>
          </g>
          <ellipse
          ...
          <g className="pot">
            <path
              className="pot-lightest"
              d="M692.21,406.62H600.14c-17,54,1.05,118,39.15,172H745.14c38.1-54,56.11-118,39.15-172Z"
            />
            <path
              className="pot-lighter"
              d="M784.29,406.62h-.63a2.49,2.49,0,0,1,.69,1.6c0,5.25-21.77,9.78-53.21,11.87-3.28,17.67-17.11,34.26-35.13,47C673.11,483,643.68,493,611.46,493q-6.24,0-12.43-.47c7.14,29.54,21.18,59.08,40.26,86.14H745.14C783.24,524.59,801.25,460.65,784.29,406.62Z"
            />
          ...
          <g className="echeveria plant">
            <g className="leaf leaf-back">
              <path
                className="echeveria-darker"
                d="M652.43,320.88c13.15,15.37,24.32,44,14.85,52.06s-36-7.35-49.14-22.71,3.32-29.19,1.53-32.93C622.82,320,639.29,305.52,652.43,320.88Z"
              />
              <path
                className="echeveria-lighter"
                d="M649.78,317.9a20,20,0,0,0-6.34-4.64c-11.32-5.07-22.87,4.26-25.45,2.08,1.46,3.05-9.27,12.85-6.06,24.71,1,2.66,1.52,4.44,3.53,6.79,13.26,15.5,29.92,25,34.71,20.89,3.07-2.63.06-14.73-14.24-31.43,14.46,16.9,25.78,21.55,28.85,18.92C669.57,351.13,663.05,333.4,649.78,317.9Z"
              />
            ...
            <g className="leaf leaf-back">
              <path
                className="echeveria-darker"
                d="M729.75,321.88c-13.15,15.37-24.32,44-14.85,52.06s36-7.35,49.14-22.71-3.32-29.19-1.53-32.93C759.36,321,742.9,306.52,729.75,321.88Z"
              />
              <path
                className="echeveria-lighter"
                d="M732.4,318.9a20.1,20.1,0,0,1,6.34-4.64c11.32-5.07,22.87,4.26,25.46,2.08-1.47,3.05,9.26,12.85,6,24.71-1,2.66-1.52,4.44-3.52,6.79-13.27,15.5-29.93,25-34.72,20.89-3.07-2.63-.06-14.73,14.24-31.43-14.46,16.9-25.78,21.55-28.85,18.92C712.62,352.13,719.14,334.4,732.4,318.9Z"
              />
            ...
            <g className="leaf leaf-back">
              <path
                className="echeveria-darker"
                d="M694.69,305.7c3.23,20-2.12,50.19-14.43,52.17s-26.9-25-30.13-45,18-23.2,18.45-27.32C669.89,289.5,691.47,285.74,694.69,305.7Z"
              />
              <path
                className="echeveria-lighter"
                d="M694,301.77a20.26,20.26,0,0,0-3-7.26c-7-10.22-21.75-8.27-22.82-11.48-.34,3.37-14.6,6.14-18,17.94-.53,2.79-1,4.59-.52,7.64,3.25,20.13,12.54,36.91,18.76,35.9,4-.64,7.72-12.53,4.21-34.24,3.55,22,10.79,31.82,14.78,31.17C693.57,340.44,697.24,321.91,694,301.77Z"
              />
            ...
            <g className="leaf">
              <path
                className="echeveria-darker"
                d="M630.56,349c20.13,12.32,42.82,40,35.22,52.43s-42.59,4.81-62.71-7.51-6.83-33.6-10.16-37.09C597.37,358.69,610.44,336.72,630.56,349Z"
              />
              <path
                className="echeveria-lighter"
                d="M626.55,346.68a23.6,23.6,0,0,0-8.71-2.87c-14.39-1.54-23.85,13-27.5,11.48,2.72,2.86-5.66,17.6,2.17,29.61,2.06,2.59,3.29,4.38,6.36,6.26,20.3,12.43,42.21,16.95,46,10.68,2.46-4-5.24-16.36-27.12-29.75,22.13,13.55,36.37,14.64,38.83,10.61C660.47,376.44,646.85,359.11,626.55,346.68Z"
              />
            ...
            <g className="leaf leaf-back">
              <path
                className="echeveria-darker"
                d="M693.49,305.7c-3.23,20,2.12,50.19,14.43,52.17s26.9-25,30.13-45-18-23.2-18.45-27.32C718.3,289.5,696.71,285.74,693.49,305.7Z"
              />
              <path
                className="echeveria-lighter"
                d="M694.2,301.77a20.08,20.08,0,0,1,3-7.26c7-10.22,21.75-8.27,22.82-11.48.34,3.37,14.6,6.14,18,17.94.53,2.79,1,4.59.52,7.64-3.25,20.13-12.54,36.91-18.76,35.9-4-.64-7.71-12.53-4.21-34.24-3.54,22-10.79,31.82-14.78,31.17C694.61,340.44,690.94,321.91,694.2,301.77Z"
              />
            ...
            <g className="leaf">
              <path
                className="echeveria-darker"
                d="M739.51,356.55C723,373.42,707.8,405.84,718.2,416s42.48-5.78,59-22.65-1.62-34.24.76-38.45C774.05,357.77,756,339.67,739.51,356.55Z"
              />
              <path
                className="echeveria-lighter"
                d="M742.82,353.28a23.59,23.59,0,0,1,7.74-4.92c13.57-5,26.3,6.74,29.48,4.39-1.94,3.44,9.79,15.67,5.14,29.24-1.36,3-2.11,5.05-4.63,7.63-16.64,17-36.77,26.77-42,21.64-3.38-3.3,1.06-17.15,19-35.49-18.14,18.55-31.68,23.1-35,19.8C717.23,390.44,726.18,370.3,742.82,353.28Z"
              />
            ...
            <g className="leaf">
              <path
                className="echeveria-darker"
                d="M723.4,360c0,26.48-13.24,64.45-29.56,64.45s-29.56-38-29.56-64.45,28.16-26.23,29.56-31.47C694.7,333.84,723.4,333.48,723.4,360Z"
              />
              <path
                className="echeveria-lighter"
                d="M723.3,354.74a26.57,26.57,0,0,0-2.35-10c-7-14.68-26.4-15.23-27.11-19.6-1.14,4.28-20.17,4.89-27.08,19.43-1.27,3.49-2.27,5.71-2.27,9.76,0,26.72,8.51,50.35,16.76,50.35,5.3,0,12.6-14.6,12.6-43.41,0,29.14,7.3,43.41,12.59,43.41C714.69,404.66,723.3,381.46,723.3,354.74Z"
              />
            ...
            <g className="leaf">
              <path
                className="echeveria-darker"
                d="M683.19,380.34c7.46,20.62,7.84,53.9-4.87,58.5s-33.7-21.23-41.16-41.85,14.55-28.35,14.16-32.82C653.5,368.08,675.73,359.72,683.19,380.34Z"
              />
              <path
                className="echeveria-lighter"
                d="M681.64,376.3a21.76,21.76,0,0,0-4.65-7.14c-9.55-9.47-24.84-4.42-26.63-7.63.32,3.66-14.31,9.49-15.6,22.76,0,3.07-.16,5.08,1,8.23,7.52,20.8,20.8,36.8,27.22,34.48,4.13-1.49,5.7-14.91-2.41-37.34,8.2,22.68,17.9,31.74,22,30.25C689,417.58,689.17,397.1,681.64,376.3Z"
              />
            ...
            <g className="leaf">
              <path
                className="echeveria-darker"
                d="M694.77,396.66c-4.29,21.5.32,54.47,13.57,57.11s30.14-26,34.43-47.55-18.63-25.85-18.91-30.33C722.29,380.08,699.05,375.15,694.77,396.66Z"
              />
              <path
                className="echeveria-lighter"
                d="M695.69,392.43a21.79,21.79,0,0,1,3.53-7.75c8-10.8,23.9-8.1,25.19-11.54.23,3.67,15.57,7.24,18.83,20.16.47,3,.92,5,.27,8.29-4.33,21.7-15.06,39.5-21.75,38.17-4.3-.86-7.87-13.89-3.21-37.28-4.71,23.66-12.95,34.06-17.25,33.2C694.61,434.35,691.37,414.12,695.69,392.43Z"
              />
